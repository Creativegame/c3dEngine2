...
void initGame(){
	...
	//load fbx
	string fbxFilePath="fbxLoader_resource/caomei/caomei.fbx";
	...
	//export values only
	{
		...
		string exportPath="export/caomei_cfc";
#elif (C3D_TARGET_PLATFORM == C3D_PLATFORM_IOS) 
		string exportPath=Cc3dDocuments::sharedDocuments()->getDocumentsPath()+"/export/caomei_cfc";
#else
		assert(false);
#endif
	...
	{
#if (C3D_TARGET_PLATFORM == C3D_PLATFORM_WIN32) 
		string exportPath="export/caomei_readable_cfc";
#elif (C3D_TARGET_PLATFORM == C3D_PLATFORM_IOS) 
		string exportPath=Cc3dDocuments::sharedDocuments()->getDocumentsPath()+"/export/caomei_readable_cfc";
#else
		assert(false);
#endif
